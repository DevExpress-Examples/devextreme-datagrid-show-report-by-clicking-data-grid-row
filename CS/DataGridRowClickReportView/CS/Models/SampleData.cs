...
namespace dxSampleDataGridAndReport.Models {
    public class SampleData {
        public List<SampleOrder> GetOrders(int orderId, DateTime date) {
            var filteredSubset = Orders.Where(x => x.OrderID == orderId && x.OrderDate == date).ToList<SampleOrder>();
